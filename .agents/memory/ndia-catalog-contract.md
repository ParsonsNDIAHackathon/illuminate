...
returned and recorded. Treat any POST outcome without a stable dataset identity
as uncertain—even an HTTP success—and block another POST until the lookup route
reconciles the original attempt.