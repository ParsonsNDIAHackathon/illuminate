...
**How to apply:** Keep health endpoints, production scripts, seed changes, and operator surfaces consistent with these signals. Trigger production recovery from operational coverage/freshness, retain seed readiness as rehearsal diagnostics, and report optional failures separately.