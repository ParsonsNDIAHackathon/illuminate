...
const headers = [{ title: 'Kind', key: 'kind', width: 90 }, { title: 'Title', key: 'title' }, { title: 'Truth status', key: 'status', width: 110 }, { title: 'About', key: 'about' }, { title: 'Source', key: 'source', width: 110 }, { title: 'Published', key: 'published_at', width: 110 }, { title: 'Retrieved', key: 'retrieved', width: 150 }, { title: 'Amount', key: 'amount', width: 130 }, { title: 'Claims', key: 'claims', width: 80 }, { title: 'View', key: 'raw', width: 60, sortable: false }]
...
<style scoped>.simulation-note { color: #8a5213; font-size: 10px; font-weight: 700; }</style>
