...
<style scoped>
.mission{--ink:#172724;--muted:#65756f;--paper:#f1f0e7;--line:#c8cec2;--teal:#075f58;--signal:#dd5a35;min-height:100%;background:var(--paper);color:var(--ink);padding:30px 36px 60px;font-family:Manrope,system-ui,sans-serif}.hero{display:grid;grid-template-columns:minmax(0,1fr) 310px;gap:48px;border-top:7px solid var(--teal);border-bottom:1px solid var(--ink);padding:28px 0}.eyebrow,.section-title span,.metrics span,.decision-card>span,.preset span{font:700 10px ui-monospace,monospace;letter-spacing:.13em;color:var(--teal)}h1{font-size:clamp(36px,5vw,68px);line-height:.98;letter-spacing:-.055em;max-width:980px;margin:12px 0 18px}.hero p{max-width:780px;color:var(--muted);font-size:16px}.hero-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:24px}.speed{display:block;margin-top:9px;color:var(--muted)}.decision-card{align-self:stretch;border-left:1px solid var(--line);padding:14px 0 14px 28px;display:flex;flex-direction:column;gap:14px}.decision-card strong{font-size:27px;line-height:1.05}.decision-card small{color:var(--muted);word-break:break-word}.decision-card .v-chip{align-self:flex-start}.section-title{display:flex;justify-content:space-between;align-items:end;margin:34px 0 14px}.section-title h2{font-size:25px;margin:4px 0 0}.metrics{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid var(--line);background:#f8f7ef}.metrics article{padding:18px;border-right:1px solid var(--line);display:grid;gap:6px}.metrics article:last-child{border:0}.metrics strong{font-size:25px}.metrics small{color:var(--muted)}.sources{display:flex;flex-wrap:wrap;gap:7px;margin-top:8px}.sources span{border:1px solid var(--line);padding:5px 8px;font:10px ui-monospace,monospace}.advisory,.state,.simulation{padding:14px 16px;background:#fae6d8;border-left:5px solid var(--signal);margin-bottom:10px}.advisory{display:flex;gap:10px}.state{background:#e5e8df;border-color:var(--teal)}.state p{margin:8px 0}.state.failure{background:#fae6d8;border-color:var(--signal)}.preset-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.preset{display:grid;grid-template-columns:30px 1fr 20px;gap:10px;align-items:start;min-height:132px;padding:18px;color:var(--ink);text-decoration:none;border:1px solid var(--line);background:#f8f7ef;transition:.15s}.preset:hover,.preset:focus-visible{transform:translateY(-2px);border-color:var(--teal);box-shadow:0 10px 25px rgba(20,50,45,.1)}.preset h3{margin:5px 0;font-size:19px}.preset p{margin:0;color:var(--muted);font-size:12px}.workflow{display:grid;grid-template-columns:repeat(4,1fr);border-top:2px solid var(--ink);border-bottom:1px solid var(--ink)}.workflow a{display:flex;gap:12px;padding:17px;color:var(--ink);text-decoration:none;border-right:1px solid var(--line)}.workflow a:last-child{border:0}.workflow b{font:700 20px ui-monospace,monospace;color:var(--signal)}.workflow span,.workflow strong{display:block}.workflow span{font-size:11px;color:var(--muted)}.workflow strong{color:var(--ink);font-size:13px;margin-bottom:4px}.simulation{display:flex;gap:12px;margin-top:30px;background:#fff1c9;border-color:#9a6700;font-size:12px}.simulation strong{display:block;letter-spacing:.1em;font-size:10px}@media(max-width:1000px){.hero{grid-template-columns:1fr}.decision-card{border-left:0;border-top:1px solid var(--line);padding:20px 0}.metrics,.preset-grid,.workflow{grid-template-columns:1fr 1fr}.metrics article:nth-child(2){border-right:0}.metrics article{border-bottom:1px solid var(--line)}}@media(max-width:650px){.mission{padding:20px 16px 40px}.metrics,.preset-grid,.workflow{grid-template-columns:1fr}.metrics article,.workflow a{border-right:0;border-bottom:1px solid var(--line)}}
</style>