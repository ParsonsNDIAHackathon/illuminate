...
SOURCE_COVERAGE: tuple[SourceCoverage, ...] = (
    ...
    _source("un-sc-consolidated", "UN Security Council Consolidated List", adapter="un_sanctions",
            endpoint="https://scsanctions.un.org/resources/xml/en/consolidated.xml",
            freshness="24 hours", kinds=("organization", "person"), categories=("sanctions",),
            limitations="Name matching requires analyst review and list coverage does not implement legal ownership analysis."),
