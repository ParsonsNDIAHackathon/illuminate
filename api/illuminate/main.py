...
for r in (news.router, graph.router, query.router, permissions.router, claims.router, enrichment.router, risk_router.router, connectors.router, settings_router.router, chat.router):
