...
| `pypi:asyncpg` | `0.31.0` | PyPI project maintainers | direct | [REVIEW_REQUIRED](https://pypi.org/project/asyncpg/0.31.0/) | yes | `review_required` | direct pypi component resolved from repository declarations. Application build or the dependent runtime capability fails Replacement: Remove or replace the depending feature and regenerate the lockfile and BOM in the same change |
