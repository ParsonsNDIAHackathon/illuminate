...
These are aggregated datasets, not individual geolocated event records. Files have been collected for storage; no application ingestion or map integration has been performed.
